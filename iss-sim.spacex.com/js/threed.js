...
function showInterface() {
    (interfaceAnimationIn = new TimelineMax({
        ...
        interfaceAnimationIn.to(camera.position, 5, { x: randomIntFromInterval(-25, 25), y: randomIntFromInterval(-25, 25),z: randomIntFromInterval(0, 50), ease: "expo.inOut" }, 2),
        interfaceAnimationIn.to(camera.rotation, 5, { x: randomIntFromInterval(-20, 20) * toRAD, y: randomIntFromInterval(-20, 20) * toRAD, z: randomIntFromInterval(-20, 20) * toRAD, ease: "expo.inOut" }, 2),
...
function resetPosition() {
    resetMovement(),
        ...
        gsap.to(camera.position, 5, { x: randomIntFromInterval(-25, 25), y: randomIntFromInterval(-25, 25), z: randomIntFromInterval(0, 50), ease: "expo.out" }),
        gsap.to(camera.rotation, 5, { x: randomIntFromInterval(-20, 20) * toRAD, y: randomIntFromInterval(-20, 20) * toRAD, z: randomIntFromInterval(-20, 20) * toRAD, ease: "expo.out" });
}
var lightObject,
    lightClose,
    lightFar,
