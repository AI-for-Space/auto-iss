...
function showInterface() {
    (interfaceAnimationIn = new TimelineMax({
        ...
        interfaceAnimationIn.to(camera.position, 5, { x: 12, y: 30,z: 50, ease: "expo.inOut" }, 2),
        interfaceAnimationIn.to(camera.rotation, 5, { x: 0 * toRAD, y: 0 * toRAD, z: 0 * toRAD, ease: "expo.inOut" }, 2),
...
function resetPosition() {
    resetMovement(),
        ...
        gsap.to(camera.rotation, 5, { x: 0 * toRAD, y: 0 * toRAD, z: 0 * toRAD, ease: "expo.out" });
}
var lightObject,
    lightClose,
    lightFar,
